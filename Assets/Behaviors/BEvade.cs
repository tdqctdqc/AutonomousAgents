...
public class BEvade : Behavior
{
    ...
    public override void Behave(float weight)
    {
        ...
        {
            DoEvade(mono.calc, transform.position, target, rb, targetRB, weight, steerer, crosshair);
        }
        
    }


    public static void DoEvade(BehaviorCalculator handler, Vector3 callerPos, Vector3 targetPos, Rigidbody2D callerRB, Rigidbody2D targetRB, float speed, Steerer steerer, Crosshair crosshair)
    {
